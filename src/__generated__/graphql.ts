...
export type LatestLaunchQuery = {
  ...
  launchLatest?: {
    ...
    links?: { __typename?: "LaunchLinks"; video_link?: string | null } | null;
  } | null;
};
...
export type GetLaunchDetailQuery = {
  __typename?: "Query";
  launch?: {
    __typename?: "Launch";
    mission_name?: string | null;
    ...
    rocket?: {
      __typename?: "LaunchRocket";
      rocket?: { __typename?: "Rocket"; id?: string | null } | null;
    } | null;
    links?: {
      __typename?: "LaunchLinks";
      mission_patch?: string | null;
...
export const LatestLaunchDocument = {
  kind: "Document",
  definitions: [
    {
...
} as unknown as DocumentNode<LatestLaunchQuery, LatestLaunchQueryVariables>;
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "mission_patch" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "video_link" },
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetLaunchDetail" },
      variableDefinitions: [
        {
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "launch_date_local" },
                },
                {
                  kind: "Field",
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "site_name_long" },
                      },
                    ],
                  },
                },
...
>;
export const GetRocketDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetRocket" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "boosters" } },
                { kind: "Field", name: { kind: "Name", value: "company" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "cost_per_launch" },
                },
                ...
                { kind: "Field", name: { kind: "Name", value: "description" } },
                {
                  ...
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "feet" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "meters" },
                      },
                    ],
                  },
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "engine_loss_max" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "propellant_1" },
                      },
                      {
                        kind: "Field",
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "thrust_sea_level" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "kN" },
                            },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "lbf" },
                            },
                          ],
                        },
                      },
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "thrust_vacuum" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "first_flight" },
                },
                {
                  kind: "Field",
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "landing_legs" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "lb" } },
                    ],
                  },
                },
                ...
                { kind: "Field", name: { kind: "Name", value: "stages" } },
                {
                  kind: "Field",
...
} as unknown as DocumentNode<GetRocketQuery, GetRocketQueryVariables>;
